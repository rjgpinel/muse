...
MUSE is a learning environment with a rich set of robotic manipulation tasks with different challenges such as: multimodality, long term, non-prehensile manipulation, deformable objects, etc. MUSE is based on the [MuJoCo](https://github.com/deepmind/mujoco) physics engine. 
